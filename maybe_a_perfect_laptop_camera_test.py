# -*- coding: utf-8 -*-
"""
Created on Fri Jul  8 14:09:58 2022
...
def display(img):
    ...
    cv2.line(img,(int(frameWidth/2)+deadZone,0),(int(frameWidth/2)+deadZone,frameHeight),(255,255,0),3)
    cv2.circle(img,(int(frameWidth/2),int(frameHeight/2)),5,(0,0,255),5)#做中心點
...
while True:
    ...
    if ret:
        ...
        img = cv2.resize(frame_read, (width, height))#作處理用
        imgContour = img.copy()#複製輸出用
