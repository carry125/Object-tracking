...
#label 建立與定位
H_min_label = tk.Label(window, text = "H_min", width = 30, bg = "grey").place(x = 10, y = 10)
H_max_label = tk.Label(window, text = "H_max", width = 30, bg = "grey").place(x = 10, y = 50)
S_min_label = tk.Label(window, text = "S_min", width = 30, bg = "grey").place(x = 10, y = 90)
S_max_label = tk.Label(window, text = "S_max", width = 30, bg = "grey").place(x = 10, y = 130)
V_min_label = tk.Label(window, text = "v_min", width = 30, bg = "grey").place(x = 10, y = 170)
V_max_label = tk.Label(window, text = "v_max", width = 30, bg = "grey").place(x = 10, y = 210)
...
#textbox 建立與定位
tk.Entry(window, width = 30, textvariable = h_min_tk).place(x = 250, y = 10)
tk.Entry(window, width = 30, textvariable = h_max_tk).place(x = 250, y = 50)
tk.Entry(window, width = 30, textvariable = s_min_tk).place(x = 250, y = 90)
tk.Entry(window, width = 30, textvariable = s_max_tk).place(x = 250, y = 130)
tk.Entry(window, width = 30, textvariable = v_min_tk).place(x = 250, y = 170)
tk.Entry(window, width = 30, textvariable = v_max_tk).place(x = 250, y = 210)
...
#button 建立與定位
button = tk.Button(window, text = "確定", width = 10, height = 1, command = button_press).place(x = 385, y = 250)
...
while True:
    ...
    lower = np.array([h_min,s_min,v_min])#可改參數
    upper = np.array([h_max,s_max,v_max])#可改參數
